    ...
    , ui(new Ui::MainWindow)
{
    ...
    QPixmap map("D:/Qt/wood61.jpg");   // подготовка изображения для установки на задний фон
...
{
    ui->pushButton->setStyleSheet("  color: white;  border-image: url(D:/Qt/wood71.png) 3 10 3 10; border-top: 3px transparent; border-bottom: 3px transparent; border-right: 10px transparent;border-left: 10px transparent; border-style: outset;border-width: 2px;border-radius: 1px;");
}


void MainWindow::on_pushButton_released()
{
    ui->pushButton->setStyleSheet("  color: black;  border-image: url(D:/Qt/wood71.png) 3 10 3 10; border-top: 3px transparent; border-bottom: 3px transparent; border-right: 10px transparent;border-left: 10px transparent; border-style: outset;border-width: 2px;border-radius: 1px;");
}


void MainWindow::on_pushClear_pressed()
{
    ui->pushClear->setStyleSheet("  color: white;  border-image: url(D:/Qt/wood71.png) 3 10 3 10; border-top: 3px transparent; border-bottom: 3px transparent; border-right: 10px transparent;border-left: 10px transparent; border-style: outset;border-width: 2px;border-radius: 1px;");
...
{
     ui->pushClear->setStyleSheet("  color: black;  border-image: url(D:/Qt/wood71.png) 3 10 3 10; border-top: 3px transparent; border-bottom: 3px transparent; border-right: 10px transparent;border-left: 10px transparent; border-style: outset;border-width: 2px;border-radius: 1px;");
}


void MainWindow::on_pushResult_pressed()
{
    ui->pushResult->setStyleSheet("  color: white;  border-image: url(D:/Qt/wood71.png) 3 10 3 10; border-top: 3px transparent; border-bottom: 3px transparent; border-right: 10px transparent;border-left: 10px transparent; border-style: outset;border-width: 2px;border-radius: 1px;");
}


void MainWindow::on_pushResult_released()
{
     ui->pushResult->setStyleSheet("  color: black;  border-image: url(D:/Qt/wood71.png) 3 10 3 10; border-top: 3px transparent; border-bottom: 3px transparent; border-right: 10px transparent;border-left: 10px transparent; border-style: outset;border-width: 2px;border-radius: 1px;");
}
